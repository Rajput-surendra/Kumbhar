...
final String packageName = 'com.example.kumbhar';
const String languageCode = 'languageCode';
final String baseUrl = 'https://alphawizztest.tk/kumbhar/api/';
...
final String baseUrl1 = 'https://alphawizztest.tk/kumbhar/api/';
