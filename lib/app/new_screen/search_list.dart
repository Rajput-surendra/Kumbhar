...
class _SearchListState extends State<SearchList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:shortList.length>0?ListView(
        children: <Widget>[
          Container(
            height: 20,
            margin: EdgeInsets.only(left: 20, top: 10),
            child: Text(
              "${shortList.length} Search Profile",
          ...
          :
      Center(child: text("No Matches",fontSize: 12.0,fontFamily: fontMedium,textColor: Colors.black,fontWeight: FontWeight.w700)),
    );
